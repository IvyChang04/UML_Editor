...
public class Generalization_mode extends Mode{
    ...
    public void mouseDragged(MouseEvent m){
        if(starting_point != null){
            Generalization_line gen = new Generalization_line(starting_point.x, starting_point.y, m.getX(), m.getY());
            canvas.drag_line = gen;
            canvas.repaint();
        }
    }
    ...
    public void mouseReleased(MouseEvent m){
        if(starting_point != null){
            ...
            if(ending_point != null){
                Super_object gen = new Generalization_line(starting_point.x, starting_point.y, ending_point.x, ending_point.y);
                canvas.add_line(gen);
                gen.set_port(conn_obj1.get_ports(port1), conn_obj2.get_ports(port2));
                conn_obj1.get_ports(port1).add_lines(gen);
                conn_obj2.get_ports(port2).add_lines(gen);
            }
        }
